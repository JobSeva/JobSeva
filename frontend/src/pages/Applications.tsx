      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {stages.map((stage, i) => {
          ...
          return (
            ...
            >
              <div
                className={`w-10 h-10 rounded-xl ${stage.color} flex items-center justify-center mx-auto`}
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="hidden md:flex items-center gap-1.5 flex-wrap">
                    {app.status === "rejected" ? (
                      ...
                      stages.filter(s => s.key !== "rejected").map((stage, si) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`w-7 h-7 rounded-full flex items-center justify-center text-[10px] shadow-sm transition-all duration-300 ${isCompleted
                                  ? stage.color
